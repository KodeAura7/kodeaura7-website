    ...
    <section className={`${compact ? 'py-20' : 'py-20 md:py-28'} border-t border-zinc-900`}>
      <div className="max-w-7xl mx-auto px-6">
        <div className="relative overflow-hidden bg-[#111113] rounded-3xl p-12 md:p-16 border border-zinc-800 text-center">
          ...
          <div className="absolute -bottom-20 -left-20 w-72 h-72 bg-secondary-500/15 rounded-full blur-[80px]" />
          <div className="relative">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link to="/#contact" className="inline-flex items-center justify-center gap-2 px-8 py-4 bg-primary-500 text-white rounded-full text-sm font-medium hover:bg-primary-400 transition-all shadow-[0_0_30px_rgba(51, 112, 246,0.3)] hover:shadow-[0_0_40px_rgba(51, 112, 246,0.5)] hover:-translate-y-0.5">
